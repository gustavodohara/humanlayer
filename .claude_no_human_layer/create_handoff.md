...
Use the following information to understand how to create your document:
    ...
    - Optionally run your own metadata script to generate all relevant metadata, or fill the fields manually
    - Examples:
...
### 3. Approve and Save
Run `git add thoughts/shared/handoffs/ && git commit -m "Add handoff document" && git push` to save and share the document.
